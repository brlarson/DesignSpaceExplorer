...
public class AllConfigHandler extends AbstractHandler {
            ...
            if (targetElement != null) {
              if (targetElement instanceof Element) {
                ...
                if (!(cc instanceof ComponentImplementation)) {
                  ...
                  Say.it("Generating all possible configurations of "+cc.getName());
//                  System.out.println("instantiate " + cc.getName());
                  try {
                    ...
                    int configLimit = 100; //FIXME! WorkspacePlugin.getDefault().getPreferenceStore().getInt(ConfigurationPreferencePage.CONFIGURATION_LIMIT);
                    		//ConfigurationPreferencePage.thePage.getSignatureLimit();
                    ...
                    {           
                      ...
                      moreConfigs = ((ConfigNode)provider.getRoot()).getNextConfiguration();
                      //InstantiateConfiguredModel.view.refresh();
                    }  //end of while loop
                    if (configNumber>=configLimit)
                      ...
                      Dialog.showError("All Configurations", "Allowed number of configurations reached:  "+configLimit+  
...
//                    }
                    ...
                    Dialog.showError("All Configurations", "Operation is not supported: " + uoe.getMessage());
                  } catch (Exception other) {
                    other.printStackTrace();
                    Dialog.showError("All Configurations", "Error when instantiating the model");
                  }
                }
              } else {
