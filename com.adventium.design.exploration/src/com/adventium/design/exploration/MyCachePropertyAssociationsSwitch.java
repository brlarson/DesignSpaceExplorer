 ...
 * @author lwrage
 */
public class MyCachePropertyAssociationsSwitch extends CachePropertyAssociationsSwitch {
	...
	protected MyCachePropertyAssociationsSwitch(final IProgressMonitor pm, final AnalysisErrorReporterManager errManager,
			...
			for (Property property : propertyFilter) {
				if (io.acceptsProperty(property)) {
					...
					if (!evaluated.isEmpty()) {
						...
						//HSS: It is this next line where we have issues!!!  because io.ownedPropertyAssociation[0].property != property
						myremovePropertyAssociations(io,property);
	...
	private void myremovePropertyAssociations(InstanceObject io, Property property) {
